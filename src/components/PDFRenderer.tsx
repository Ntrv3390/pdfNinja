        ...
        <div className="w-full bg-white rounded-md shadow flex flex-col items-center">
            <div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2">
                ...
                <div className='space-x-2'>
                    ...
                    <Button onClick={() => setRotation((prev) => prev + 90)} variant="ghost" aria-label='rotate'>
            ...
            <div className="flex-1 w-full max-h-screen">
                ...
                <div ref={ref}>
                    <Document onLoadSuccess={({numPages})=> {
                        ...
                        { isLoading && renderedScale ? <Page key={"@" + renderedScale} pageNumber={currPage} width={width ? width : 1} scale={scale} rotate={rotation}/> : null}
                        <Page key={"@" + scale} loading={
                            <div className='flex justify-center'>
                                <Loader2 className='my-24 h-6 w-6 animate-spin'/>
                            </div>
                        } onRenderSuccess={() => {
                            setRenderedScale(scale)
                        }} className={cn(isLoading ? 'hidden':"")} pageNumber={currPage} width={width ? width : 1} scale={scale} rotate={rotation}/> 
                    </Document>
                </div>
                </SimpleBar>
            </div>
