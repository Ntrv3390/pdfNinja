...
const UploadDropZone = ({isSubscribed} : {isSubscribed : boolean}) => {
    ...
    return <Dropzone multiple={false} onDrop={async (acceptedFile) => {
        setIsUploading(true);
        const progressInterval = startSimulatedProgess();
    ...
    }}>
        {
            (
                ...
                <div {...getRootProps()} className='border h-64 m-4 border-gray-300 rounded-lg'>
                            ...
                            <div className='flex flex-col items-center justify-center
                             ...
                             {isUploading ? (
                                <div className='w-full mt-4 max-w-xs mx-auto'>
                                    ...
                                    {uploadProgress === 100 ? (
                                        <div className='flex gap-1 items-center justify-center text-sm text-center text-zinc-700 pt-2'>
